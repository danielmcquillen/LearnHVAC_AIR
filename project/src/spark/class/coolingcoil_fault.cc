...
///
/// \code
/// A,fLeak,posReal,mLiqOpenReal,UAReal = coolingcoil_fault (StuckValve,BootLeakage,OversizedValve,LeakyValve,ObstructedPipe,UndersizedCoil,FouledCoil,Status,pos,mLiqOpen,UADes)
/// \endcode
///
///////////////////////////////////////////////////////////////////////////////
/// \par  History
...
if (BootLeakage > 0.0) // Valve is normally closed
  posReal = SPARK::min(posReal, (1-BootLeakage));
...
//   cout << "StuckValve=" << StuckValve << endl;
//   cout << "posReal=" << posReal << endl;
//   cout << "pos=" << pos << endl;
